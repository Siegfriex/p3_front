...
- Name: atlas-contract-shell.spec.ts >> CONTRACT_FIXTURE route and query shell >> restores filters and node selection through URL, reload, Back, and Forward
- Location: tests/e2e/atlas-contract-shell.spec.ts:125:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: /A1 계약 주제 하나/ }) resolved to 2 elements:
  ...
  - main [ref=e37]:
    - generic [ref=e38]:
      ...
      - generic [ref=e44]:
        ...
        - paragraph [ref=e70]: 1개 node 표시
        - generic [ref=e71]:
          - region "답변행태 aggregate node" [ref=e72]:
            - generic [ref=e73]:
              - heading "답변행태 aggregate node" [level=2] [ref=e74]
              - paragraph [ref=e75]: 1개 aggregate node. 위치는 주제 투영 좌표, 모양은 답변행태, 크기는 정규화 질량을 나타냅니다.
            - group "답변행태 지도 1개 aggregate node. 위치는 주제 투영 좌표, 모양은 답변행태, 크기는 정규화 질량을 나타냅니다. 아래 동기화 목록으로도 모든 node를 탐색할 수 있습니다." [ref=e76]:
              - button "A1 계약 주제 하나, complete, 답변 2건" [ref=e79] [cursor=pointer]
          - complementary "선택 node 상세" [ref=e82]:
            - paragraph [ref=e83]: node를 선택하면 계약 필드가 여기에 표시됩니다.
        - region "접근 가능한 node 목록" [ref=e84]:
          - heading "접근 가능한 node 목록" [level=2] [ref=e85]
          - paragraph [ref=e86]: 지도와 같은 필터 결과를 텍스트 목록으로 탐색합니다.
          - list [ref=e87]:
            - listitem [ref=e88]:
              - button "A1 계약 주제 하나 (2건)" [ref=e89] [cursor=pointer]:
                - text: A1 계약 주제 하나
                - generic [ref=e90]: (2건)
        - complementary "투영 해석 주의" [ref=e91]:
          - paragraph [ref=e92]: 이 지도는 의미적 위치를 2차원으로 투영한 표시용 공간입니다.
          - paragraph [ref=e93]: 2차원 거리 자체를 실제 유사도 점수로 해석하지 마십시오.
  - contentinfo [ref=e94]:
    - generic [ref=e95]:
      - generic [ref=e96]: "PROJECT: P3_CULTURE"
      - generic [ref=e99]: 원론적/유보적 답변 (42%)
      - generic [ref=e102]: 공식 완결 (18%)
      - generic [ref=e105]: 진행/이관 (40%)
    - generic [ref=e106]:
      - generic [ref=e107]: "CHAPTER: PROLOGUE"
      - generic [ref=e108]: "|"
      - generic [ref=e109]: V1.0 EDITORIAL SCROLLYTELLING
```
