          ...
          <div className="space-y-8 text-[var(--color-neutral-900)]">
            ...
            <section className="p-6 bg-[var(--color-surface)] border border-[var(--color-neutral-200)] space-y-3">
              ...
              <div className="space-y-2 type-caption font-mono text-[var(--color-neutral-700)]">
                <div>- A1: 원론적 검토 표명 ("상호 협의하여 장기 검토하겠음")</div>
                <div>- A2: 법령 및 예산 한계 제시 ("관계 법령 개정 및 예산 확보 후 추진")</div>
                <div>- A3: 타 기관 책임 이관 ("지자체 및 관계부처 간 협의 진행 중")</div>
                <div>- A4: 단순 현황 설명 대치 ("현재 OO 사업을 추진하고 있음")</div>
                <div>- A5: 실질 이행 완료 보고 ("시정 조치 및 규정 개정 완료함")</div>
                <div>- A6: 수용 불가 / 타당성 부재 ("사업 특성상 반영 불허")</div>
                <div>- A7: 정량 수치 중심 답변 ("OO건 실적 달성 및 사업 추진 완료")</div>
                <div>- A8: 자체 조사 / 감사 진행 ("자체 감사 진행 중이며 조치 예정")</div>
              </div>
            </section>
